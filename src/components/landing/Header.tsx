...
export function Header() {
  return (
    <header className="sticky top-0 z-40 border-b border-border/80 bg-white/90 backdrop-blur-md">
      <div className="mx-auto grid w-full max-w-6xl grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-1.5 px-3 py-3 sm:gap-4 sm:px-6 sm:py-4">
        <Link href="/" className="min-w-0 shrink-0" aria-label="Couverture Mutuelle">
          <Image
        ...
        <a
          href="#devis"
          className="inline-flex min-h-9 shrink-0 items-center rounded-full bg-brand px-2.5 font-sora text-xs font-semibold text-white transition hover:bg-[#5b21b6] sm:min-h-10 sm:px-5 sm:text-sm"
        >
          Comparer
        </a>
      </div>
